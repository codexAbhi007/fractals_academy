...
const btnPrimary = `${btnInteractive} bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600`;
        ...
        <div className="container mx-auto px-3">
          <div className="flex h-14 items-center justify-between">
            <div className="flex items-center gap-3">
              <Link
                href="/"
                className={`p-1.5 rounded-lg border border-white/10 hover:bg-white/5 ${btnInteractive}`}
              >
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                className={`text-muted-foreground hover:text-foreground h-8 w-8 p-0 ${btnInteractive}`}
              >
      ...
      <main className="container mx-auto px-3 py-4">
        ...
        >
          <TabsList className="bg-white/5 border border-white/10 h-9">
            <TabsTrigger
              value="overview"
              className="data-[state=active]:bg-purple-500/20 text-xs h-7 cursor-pointer"
            >
            ...
            <TabsTrigger
              ...
              className="data-[state=active]:bg-purple-500/20 text-xs h-7 cursor-pointer"
            >
              <ChartLine className="h-3.5 w-3.5 mr-1.5" />
              Progress
            </TabsTrigger>
            <TabsTrigger
              value="settings"
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="p-3">
                <div className="flex flex-wrap gap-3 items-center">
                  ...
                  >
                    <SelectTrigger className="w-[120px] h-8 text-xs border-white/10 bg-white/5 cursor-pointer">
                  ...
                  >
                    <SelectTrigger className="w-[140px] h-8 text-xs border-white/10 bg-white/5 cursor-pointer">
                      ...
                      profile?.preferredBatch ? (
                        <div className="text-xs text-muted-foreground">
                          ...
                          {profile.preferredClassLevel
                            ...
                            : ""}
                          {profile.preferredClassLevel && profile.preferredBatch
                            ? " • "
                            : ""}
                          {profile.preferredBatch || ""}
                        </div>
